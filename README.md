...
1️⃣ Ingestão (Roteiros/ingestao.ipynb) — Camada Bronze


Lê o arquivo CSV da pasta Pousar/ (separador ;, padrão brasileiro).
...
2️⃣ Enriquecimento (Roteiros/enriquecimento.ipynb) — Camada Silver
...
3️⃣ Refinamento (Roteiros/refinamento.ipynb) — Camada Gold
...
projeto/
├─ Pousar/                     # arquivos CSV de origem (landing)
│  ├─ z0019_1.csv
│  └─ z0019_2.csv
├─ Roteiros/                   # notebooks do pipeline
